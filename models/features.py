...
from models.full_extraction_models import FeatureExtractors
from models.rcm_nets import FEAT_H, FEAT_W
...
class MultimodalFeatures(torch.nn.Module):
    def __init__(self, image_size = 224):
        ...
        self.resize = torch.nn.AdaptiveAvgPool2d((FEAT_H, FEAT_W))
    ...
    def get_features_maps(self, rgb, pc):
        ...
        xyz_patch_full_2d = xyz_patch_full.view(1, interpolated_pc.shape[1], self.image_size, self.image_size)  #(B,C,H,W)
