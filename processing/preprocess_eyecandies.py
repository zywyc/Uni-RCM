...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='your_dataset_path', type=str, help="Original Eyecandies dataset path.")
    parser.add_argument('--target_dir', default='your_target_dir', type=str, help="Processed Eyecandies dataset path")
